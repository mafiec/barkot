...
const AboutUs = (props) => {
    return(
        <div>
            <h1>O NAS</h1>
                <img className='rightSidePhoto' src={require('../../assets/photos/oNas1.jpg')} alt='Magda z dziećmi' />
                <p className='justify'>Fundacja jest młodą organizacją założoną w 2018 roku.
