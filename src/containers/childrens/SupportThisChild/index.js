...
const SupportThisChild = (props) => {
    return(
        <div>
            ...
            <p className='link'>Jeśli chcesz stale wspierać {props.name2}, śledzić jego sukcesy, otrzymywać aktualne zdjęcia, czy nawet wymieniać z nim korespondencję, wypełnij formularz w zakładce <NavLink to='/barkot/adoption'>ADOPCJA NA ODLEGŁOŚĆ</NavLink>, wskazując imię {props.name1}.</p>   
        </div>
    );
}
