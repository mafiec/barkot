    ...
    return(
        <div>
            ...
            <div className='container'>
                <img src={require('../../assets/photos/raporty.jpg')} alt='Raport misyjny' />
            ...
            <h2>Jak?</h2>
            <p>Wystarczy, że zdeklarujesz chęć otrzymywania raportów. Wyślij maila na <span id='reportsMail'>fundacjabarkot@gmail.com</span> w tytule wpisując „raporty”, a w treści podaj swój adres korespondencyjny. Będzie on wykorzystywany wyłącznie w celu wysyłania raportów.</p>
