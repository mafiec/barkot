        ...
        <div className='justify'>
            ...
            <div id='adoptionTableContainer'>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Tamru</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/tamru.jpg')} alt='Tamru' /></td>
                        <td>150 zł</td>
                    </tr>
                    <tr>
                        <td>Solomon</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/solomon.jpg')} alt='Solomon' /></td>
                        <td>150 zł</td>
                    </tr>
                    <tr>
                        <td>Binyam</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/binyam.jpg')} alt='Binyam' /></td>
                        <td>0 zł - adoptowany</td>
                    </tr>
                    <tr>
                        <td>Estifanos</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/estifanos.jpg')} alt='Estifanos' /></td>
                        <td>0 zł - adoptowany</td>
                    </tr>
                </tbody>
                </table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Habtamu</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/habtamu.jpg')} alt='Habtamu' /></td>
                        <td>150 zł</td>
                    </tr>
                    <tr>
                        <td>Tarekegn</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/tarekegn.jpg')} alt='Tarekegn' /></td>
                        <td>150 zł</td>
                    </tr>
                    <tr>
                        <td>Erdachew</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/erdachew.jpg')} alt='Erdachew' /></td>
                        <td>150 zł</td>
                    </tr>
                    <tr>
                        <td>Abraham</td>
                        <td><img className='responsiveImage' src={require('../../assets/photos/abraham.jpg')} alt='Abraham' /></td>
                        <td>0 zł - adoptowany</td>
                    </tr>
                </tbody>
                </table>
            ...
            <p id='adoption4'>Obecnie strona jest jeszcze w budowie, dlatego jeśli jesteś zainteresowany/zainteresowana adopcją, wyślij do nas wiadomość na adres e-mail <span className='mail'>fundacjabarkot@gmail.com</span> w treści podając następujące informacje:</p>
