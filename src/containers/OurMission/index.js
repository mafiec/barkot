...
const OurMission = (props) => {
    return(
        <div>
            <h1>NASZA MISJA</h1>
            <div id='ourMission1'>
                <img src={require('../../assets/photos/naszaMisja2.jpg')} alt='Dzieci przebierające śmieci' />
            ...
            <div className='container'>
                ...
                <img src={require('../../assets/photos/naszaMisja1.jpg')} alt='Dziecko śpiące na ulicy' />
            </div>
            <div className='container'>
                <img src={require('../../assets/photos/naszaMisja3.jpg')} alt='Dzieci ulicy' />
                <div className='rightSideText'>
                    <h2>Jak Chcemy Pomóc?</h2>
