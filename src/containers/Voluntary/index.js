        ...
        <div>
          <h1>WOLONTARIAT</h1>  
            ...
            <div className='container'>
                ...
                <img src={require('../../assets/photos/wolontariat1.jpg')} alt='Dzieci rysują' />
            </div>
            <div className='voluntary'>
                <h2>Rekrutacja trwa!</h2>
                <p>Napisz do nas maila na <span id='voluntaryMail'>fundacjabarkot@gmail.com</span> przedstawiając kim jesteś, czym się zajmujesz oraz dlaczego jesteś zainteresowany/a wolontariatem. Podaj również swój numer telefonu, a my się z Tobą skontaktujemy.</p>
